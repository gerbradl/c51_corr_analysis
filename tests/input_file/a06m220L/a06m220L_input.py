...
priors['omega_E_0']  = gv.gvar(0.475, .02)
priors['omega_zS_0'] = gv.gvar(2.7e-4, 7e-5)
priors['omega_zP_0'] = gv.gvar(5.5e-4, 2e-4)

priors['pion_E_0']  = gv.gvar(0.067, .003)
priors['pion_zS_0'] = gv.gvar(0.04, 0.005)
priors['pion_zP_0'] = gv.gvar(0.08,  0.006)

priors['kaon_E_0']  = gv.gvar(0.1475, .0008)
priors['kaon_zS_0'] = gv.gvar(0.03, 0.005)
priors['kaon_zP_0'] = gv.gvar(0.058, 0.005)

priors['mres-L']    = gv.gvar(2.5e-5, 2.5e-6)
