...
priors['omega_E_0']  = gv.gvar(0.98, .02)
priors['omega_zS_0'] = gv.gvar(0.0018, 0.0004)
priors['omega_zP_0'] = gv.gvar(0.006, 0.0015)

priors['pion_E_0']  = gv.gvar(0.082, .002)
priors['pion_zS_0'] = gv.gvar(0.11, 0.01)
priors['pion_zP_0'] = gv.gvar(0.32,  0.03)

priors['kaon_E_0']  = gv.gvar(0.302, .0015)
priors['kaon_zS_0'] = gv.gvar(0.058, 0.006)
priors['kaon_zP_0'] = gv.gvar(0.15, 0.02)

priors['mres-L']    = gv.gvar(1.65e-4, 0.5e-5)
priors['mres-S']    = gv.gvar(9.6e-5, 0.5e-5)
