...
priors['omega_E_0']  = gv.gvar(0.74, .02)
priors['omega_zS_0'] = gv.gvar(8e-4, 2e-4)
priors['omega_zP_0'] = gv.gvar(0.0023, 0.0005)

priors['pion_E_0']  = gv.gvar(0.1207, .002)
priors['pion_zS_0'] = gv.gvar(0.05, 0.005)
priors['pion_zP_0'] = gv.gvar(0.13,  0.01)

priors['kaon_E_0']  = gv.gvar(0.232, .002)
priors['kaon_zS_0'] = gv.gvar(0.04, 0.01)
priors['kaon_zP_0'] = gv.gvar(0.1, 0.02)

priors['mres-L']    = gv.gvar(1.5e-4, 2e-5)
