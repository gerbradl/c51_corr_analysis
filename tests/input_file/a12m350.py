# -*- coding: utf-8 -*-
"""
Created on Tue Feb  7 22:25:00 2023
...
corr_lst = {
    'omega':{
        'dsets'     :['a12m350/omega_m'],
        'xlim'      :[4,30],
        'ylim'      :[0.9,1.2],
        # optimal fit params
        'n_state'   :3,
        't_range'   :np.arange(4,18),
    },
    'pion':{
        'dsets'     :['a12m350/piplus'],
        'xlim'      :[3,40],
        'ylim'      :[0.2,0.24],
        # optimal fit params
        'n_state'   :2,
    ...
    'mres-L':{
        'corr_array':False,
        'dset_MP'   :['a12m350/mp_l'],
        'dset_PP'   :['a12m350/pp_l'],
        'xlim'      :[0,64.5],
        'ylim'      :[0.0006,0.0009],
        # optimal fit params
    ...
    'mres-S':{
        'corr_array':False,
        'dset_MP'   :['a12m350/mp_s'],
        'dset_PP'   :['a12m350/pp_s'],
        'xlim'      :[0,64.5],
        'ylim'      :[0.0004,0.0006],
        # optimal fit params
        't_range'   :np.arange(10,33),
...
priors['omega_E_0']  = gv.gvar(1.02, .04)
priors['omega_zS_0'] = gv.gvar(0.00187, 5e-4)
priors['omega_zP_0'] = gv.gvar(.0066, .002)

priors['pion_E_0']  = gv.gvar(0.2145, .01)
priors['pion_zS_0'] = gv.gvar(0.066, 1.2e-2)
priors['pion_zP_0'] = gv.gvar(0.184, 5e-2)

priors['kaon_E_0']  = gv.gvar(0.333, .006)
priors['kaon_zS_0'] = gv.gvar(0.0555, 9e-3)
priors['kaon_zP_0'] = gv.gvar(0.153, 3e-2)

priors['mres-L']    = gv.gvar(0.00076, 1e-4)
priors['mres-S']    = gv.gvar(0.0005, 7e-5)
