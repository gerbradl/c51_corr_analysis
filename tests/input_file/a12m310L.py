...
priors['omega_E_0']  = gv.gvar(1.01, .02)
priors['omega_zS_0'] = gv.gvar(0.0018, 0.0004)
priors['omega_zP_0'] = gv.gvar(0.006, 0.0015)

priors['pion_E_0']  = gv.gvar(0.189, .004)
priors['pion_zS_0'] = gv.gvar(0.065, 0.01)
priors['pion_zP_0'] = gv.gvar(0.19,  0.02)

priors['kaon_E_0']  = gv.gvar(0.324, .002)
priors['kaon_zS_0'] = gv.gvar(0.054, 0.005)
priors['kaon_zP_0'] = gv.gvar(0.15, 0.02)

priors['mres-L']    = gv.gvar(7.7e-4, 4e-5)
priors['mres-S']    = gv.gvar(4.95e-4, 1.5e-5)
