...
priors['omega_E_0']  = gv.gvar(0.98, .025)
priors['omega_zS_0'] = gv.gvar(0.0001, 0.00002)
priors['omega_zP_0'] = gv.gvar(-0.6e-5, 0.1e-5)

priors['pion_E_0']  = gv.gvar(0.134, .01)
priors['pion_zS_0'] = gv.gvar(0.012, 0.0018)
priors['pion_zP_0'] = gv.gvar(0.23,  0.03)

priors['kaon_E_0']  = gv.gvar(0.31, .005)
priors['kaon_zS_0'] = gv.gvar(0.008, 0.0015)
priors['kaon_zP_0'] = gv.gvar(0.15, 0.025)

priors['mres-L']    = gv.gvar(4.1e-4, 2.5e-5)
priors['mres-S']    = gv.gvar(2.4e-4, 2.5e-5)
