...
priors['omega_E_0']  = gv.gvar(0.74, .03)
priors['omega_zS_0'] = gv.gvar(1.5e-5, 3e-6)
priors['omega_zP_0'] = gv.gvar(0.0012, 0.0002)

priors['pion_E_0']  = gv.gvar(0.0975, .005)
priors['pion_zS_0'] = gv.gvar(0.004, 0.0005)
priors['pion_zP_0'] = gv.gvar(0.14,  0.015)

priors['kaon_E_0']  = gv.gvar(0.229, .002)
priors['kaon_zS_0'] = gv.gvar(0.0027, 0.0005)
priors['kaon_zP_0'] = gv.gvar(0.1, 0.02)

priors['mres-L']    = gv.gvar(1.7e-4, 2e-5)
priors['mres-S']    = gv.gvar(8.5e-5, 1e-5)
