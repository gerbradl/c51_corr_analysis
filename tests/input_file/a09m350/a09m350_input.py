...
priors['proton_E_0']  = gv.gvar(0.51, .02)
priors['proton_zS_0'] = gv.gvar(7.0e-4, 1.0e-4)
priors['proton_zP_0'] = gv.gvar(2.5e-3, 0.8e-3)

priors['omega_E_0']  = gv.gvar(0.76, .02)
priors['omega_zS_0'] = gv.gvar(8e-4, 2e-4)
priors['omega_zP_0'] = gv.gvar(0.0025, 0.0005)

priors['pion_E_0']  = gv.gvar(0.158, .005)
priors['pion_zS_0'] = gv.gvar(0.045, 0.005)
priors['pion_zP_0'] = gv.gvar(0.115,  0.01)

priors['kaon_E_0']  = gv.gvar(0.247, .003)
priors['kaon_zS_0'] = gv.gvar(0.04, 0.01)
priors['kaon_zP_0'] = gv.gvar(0.1, 0.02)

priors['mres-L']    = gv.gvar(2.6e-4, 2e-5)
priors['mres-S']    = gv.gvar(1.9e-4, 2e-5)
