...
priors['omega_E_0']  = gv.gvar(0.72, .025)
priors['omega_zS_0'] = gv.gvar(7e-4, 1.5e-4)
priors['omega_zP_0'] = gv.gvar(0.0017, 0.0008)

priors['pion_E_0']  = gv.gvar(0.06, .005)
priors['pion_zS_0'] = gv.gvar(0.07, 0.01)
priors['pion_zP_0'] = gv.gvar(0.19,  0.03)

priors['kaon_E_0']  = gv.gvar(0.2185, .0015)
priors['kaon_zS_0'] = gv.gvar(0.04, 0.01)
priors['kaon_zP_0'] = gv.gvar(0.1, 0.02)

priors['mres-L']    = gv.gvar(9.5e-5, 1e-5)
priors['mres-S']    = gv.gvar(4.25e-5, 0.5e-5)
