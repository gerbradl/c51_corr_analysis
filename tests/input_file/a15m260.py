# -*- coding: utf-8 -*-
"""
Created on Sun Feb 12 15:26:37 2023
...
corr_lst = {
    ...
    'mres-L':{
        'corr_array':False,
        'dset_MP'   :['a15m260/mp_l'],
        'dset_PP'   :['a15m260/pp_l'],
        'xlim'      :[0,64.5],
        'ylim'      :[0.0007,0.0009],
        # optimal fit params
    ...
    'mres-S':{
        'corr_array':False,
        'dset_MP'   :['a15m260/mp_s'],
        'dset_PP'   :['a15m260/pp_s'],
        'xlim'      :[0,64.5],
        'ylim'      :[0.00045,0.0006],
        # optimal fit params
...
priors['omega_E_0']  = gv.gvar(1.2128, .04)
priors['omega_zS_0'] = gv.gvar(0.00224, 4e-4)
priors['omega_zP_0'] = gv.gvar(.01102, .002)

priors['pion_E_0']  = gv.gvar(0.196, .01)
priors['pion_zS_0'] = gv.gvar(0.0805, 2e-2)
priors['pion_zP_0'] = gv.gvar(0.28, 10e-2)

priors['kaon_E_0']  = gv.gvar(0.3915, .002)
priors['kaon_zS_0'] = gv.gvar(0.059, 12e-3)
priors['kaon_zP_0'] = gv.gvar(0.201, 6e-2)

priors['mres-L']    = gv.gvar(0.000803, 0.5e-4)
priors['mres-S']    = gv.gvar(0.0005232, 4e-5)
