...
priors['omega_E_0']  = gv.gvar(0.77, .02)
priors['omega_zS_0'] = gv.gvar(9e-4, 2e-4)
priors['omega_zP_0'] = gv.gvar(0.0028, 0.0005)

priors['pion_E_0']  = gv.gvar(0.182, .004)
priors['pion_zS_0'] = gv.gvar(0.045, 0.005)
priors['pion_zP_0'] = gv.gvar(0.115,  0.01)

priors['kaon_E_0']  = gv.gvar(0.255, .002)
priors['kaon_zS_0'] = gv.gvar(0.04, 0.01)
priors['kaon_zP_0'] = gv.gvar(0.1, 0.02)

priors['mres-L']    = gv.gvar(2.6e-4, 2e-5)
priors['mres-S']    = gv.gvar(2.0e-4, 2e-5)
