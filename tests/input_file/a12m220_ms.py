...
#fit_states = ['omega']
bs_seed = 'a12m220_ms'
plot_name = 'a12m220_ms'
data_seed = 'a12m220_ms'
Tmax = 64
Tmid = 32
...
priors['omega_E_0']  = gv.gvar(0.89, .025)
priors['omega_zS_0'] = gv.gvar(0.00008, 0.00002)
priors['omega_zP_0'] = gv.gvar(0.0045, 0.0007)

priors['pion_E_0']  = gv.gvar(0.134, .008)
priors['pion_zS_0'] = gv.gvar(0.012, 0.0018)
priors['pion_zP_0'] = gv.gvar(0.23,  0.03)

priors['kaon_E_0']  = gv.gvar(0.246, .003)
priors['kaon_zS_0'] = gv.gvar(0.008, 0.0015)
priors['kaon_zP_0'] = gv.gvar(0.15, 0.025)

priors['mres-L']    = gv.gvar(3.78e-4, 1.45e-5)
priors['mres-S']    = gv.gvar(2.7e-4, 2e-5)
